...
StraightBet::StraightBet( const Bin& bin, Currency _amount ) :
    myBet( bin ),
    amount( _amount )
{
}

Currency StraightBet::Table( const Bin& outcome )
{
    static const unsigned int payout = 35;

    if ( outcome == myBet ) // win
